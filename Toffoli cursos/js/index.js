    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a id="page2" class="nav-link" href="${objPath.register}">Register</a>
                </li>
                <li class="nav-item">
                <a id="editPage" class="nav-link" href="${objPath.edit}">Edit</a>
                </li>
                <li class="nav-item">
                    <a id="deletePage" class="nav-link" href="${objPath.delete}">Delete</a>
                </li>

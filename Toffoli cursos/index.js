const infoImgsAnimes = [
    ...
    { name: 'Pikachu', imagem: './Imgs/Pikachu.jpg', informacao: 'ts nature is to store up electricity. Forests where nests of Pikachu live are dangerous, since the trees are so often struck by lightning.' },
